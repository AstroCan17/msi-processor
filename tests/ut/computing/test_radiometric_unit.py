...
def test_computing_model_is_loaded():
    ...
    assert set(RadiometricUnit.get_available_modes()) == {"default", "calibration"}
    assert RadiometricUnit.get_mandatory_input_list("default") == ["l1a"]
    assert RadiometricUnit.get_mandatory_adf_list("default") == ["dark", "nuc"]
